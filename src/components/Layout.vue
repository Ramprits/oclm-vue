<template>
  <section>
      ...
      <div class="container">
        ...
        <div class="navbar-menu">
          <div class="navbar-start is-centered-absolute">
            <router-link class="navbar-item" to="/work-orders"
              >Work Order</router-link
            ><router-link class="navbar-item" to="/field-agent"
              >Field Agent</router-link
    ...
    <div class="is-hidden" id="sideMenuHeaders07">
      <div
